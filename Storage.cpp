...
void Store::FindLname()
{
    ...
    string findLName; // переменная хранин введеную фамилию
    cout << "\nЧтобы узнать информацию о людях, введите фамилию: ";
    cin >> findLName;
    ...
    {
        // если мы нашли такую фамилию
        if ((array[id]->GetLname()).find(findLName) != std::string::npos)
        {
    ...
    if (!flagFind) cout << "\nЛюдей с такой фамилией нет!" << endl; // если не нашли пункт
}
